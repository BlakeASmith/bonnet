...
class BonnetDB:
    def __init__(self, db_path: str = "bonnet.db"):
    ...
    def store_entity(self, e_id: str, entity_name: str, memo_search: str) -> bool:
    ...
    def store_attribute(self, e_id: str, attr_type: str, subject: str, detail: str, date: str = None) -> bool:
    ...
    def get_entity_context(self, e_id: str) -> Dict:
